...
7. **No Medical Advice**: I understand that AI Coach provides athletic coaching feedback only and does not constitute medical advice. Any concerns about my child's health or physical development should be discussed with a qualified healthcare professional.

By providing consent, I acknowledge that I have read and understood the above terms and agree to allow my child to participate in athletic assessments using the AI Coach platform.
""".strip()
